...
# Category
browser.find_element_by_xpath('//input[@name="id" and @value="96"]').click()

# Main post page
title_area = browser.find_element_by_xpath('//input[@name="PostingTitle" and @id="PostingTitle"]')
title_area.send_keys('Brand New Fire Stick Lite Fully Loaded Jailbroken With Latest Apps')
...
# sale_manufacturer
sale_manufacturer = browser.find_element_by_xpath('//input[@name="sale_manufacturer"]')
sale_manufacturer.send_keys("Amazon")
...
# browser.find_element_by_xpath('//li[@id="ui-id-36"]').click()
